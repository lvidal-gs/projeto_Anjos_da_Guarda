...
<body>
  ...
  <div id="busca" style="margin-top: 100px; " class="container theme-showcase" role="main">
          ...
          <div class="modal-body">
            ...
            <form action="pesquisar.php" method="GET">
              ...
              <div class="field">
                ...
                <select name="filtro_nece">
                  <option value="" selected>Nenhum valor selecionado</option>
                  <option value="6">Preciso de enfermeiros autônomos</option>
                  <option value="3">Preciso de um cuidador de idosos</option>
                  <option value="4">Preciso de um cuidador de crianças/babysitter</option>
                  <option value="2">Preciso de um cuidador de PcD's</option>
                  <option value="1">Preciso de um cuidador de PcNE's</option>
                  <option value="5">Preciso de um tratador de feridos</option>
    ...
    <nav style="margin: 15px 0 15px 0" class="text-center" aria-label="Paginação Busca">
      <ul class="pagination">
        <?php if ($pag_ant != 0) { ?>
          <li class="page-item"><a style="color: var(--primary-color);" class="page-link" href="telaBusca.php?pagina=<?php echo $pag_ant; ?>">
        ...
        <?php for ($i = 1; $i < $num_pagina + 1; $i++) { ?>
          <li aria-current="page" class="page-item"><a style="color: var(--primary-color);" class="page-link" href="telaBusca.php?pagina=<?php echo $i; ?>"><?php echo $i; ?> <span class="sr-only">(current)</span></a></li>
        <?php } ?>

        <?php if ($pag_post <= $num_pagina) { ?>
          <li class="page-item"><a style="color: var(--primary-color);" class="page-link" href="telaBusca.php?pagina=<?php echo $pag_post; ?>" aria-label="Next">Próximo <span aria-hidden="true">&raquo;</span></a></li>
        <?php } else { ?>
