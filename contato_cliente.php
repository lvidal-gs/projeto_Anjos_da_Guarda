                ...
                <fieldset>
                    ...
                    <div class="field">
                        ...
                        <select id="tipo" name="tipo" required name="assunto">
                            ...
                            <option value="4">Eu quero excluir minha conta.</option>
                    ...
                    <script>
                        $(function() {
                            ...
                            var placeholders = {
                                '1': 'Insira o nome completo do cuidador, o telefone e o por quê da denúncia.',
                                ...
                                '4': 'Conte o porquê você quer exluir sua conta.',
                                '5': 'Conte detalhadamente sobre o que você quer nos contar.'
                            };
