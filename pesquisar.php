...
$valor_sobrenome = $_GET['filtro_sobrenome'];
...
$cuidador = "SELECT c.*, e.`relacao`
            ...
            AND sobrenome LIKE '%$valor_sobrenome%'
...
<body>
    ...
    <div id="busca" style="margin-top: 100px; " class="container theme-showcase" role="main">
        ...
        <!-- BOTAO FILTRO MODAL -->
        <a href="telaBusca.php"><button type="button" class="btn btn-primary">
                Retirar filtros
            </button></a><br>
        ...
        <?php if($total_cuidadores == 0){ ?>
              ...
              <div class='card text-center'>
                  <div class='card-header bg-danger text-white'>
                      <t style='font-weight: bolder;'>Nenhum cuidador encontrado!</t>
                  </div>
                  <div class='card-body'>
                      <h5 class='card-title'>Reescreva os parâmetros colocados no filtro.</h5>
                      <p class='card-text'>Não encontramos nenhum cuidador cadastrado na nossa plataforma com esses parâmetros, altere-os e tente novamente.</p>
                      <a href='telaBusca.php' class='btn btn-primary'>Entendi, vou alterá-los!</a>
                  </div>
              </div>
        <?php } ?>
        <?php
